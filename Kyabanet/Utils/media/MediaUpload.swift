...
class MediaUpload: NSObject {
    ...
    class func driverLicense(_ name: String, data: Data, completion: @escaping (_ error: Error?) -> Void) {

        FireStorage.upload(data: data, dir: "driverLicense", name: name, ext: "jpg", completion: completion)
    }
